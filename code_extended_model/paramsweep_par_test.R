...
save(fixed_parameters,parameters,error_cat,error_rule,error_genetic,error_cat_mean,error_cat_sd,error_rule_mean,error_genetic_mean,run.time,file=paste('/Users/eleanorbrush/Desktop/summary_stats_test','.Rdata',sep=''))
