...
## ---- parameters -------------------------
Tfights = 50 #total number of fights 
N = 20 # individuals
perc_wind = 0.5 # difference that animals can perceive
...
dynamics_full <- function(){
	...
	a_cat_byind = array(NA, dim=c(N,N,Tfights+1)) #assessment by each indivdual of each other individual, using categories
	a_ind = array(NA, dim=c(N,N,Tfights+1)) #assessment by each indivdual of each other individual
