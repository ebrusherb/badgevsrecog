...
N_vals = c(50)
xN = length(N_vals)
perc_vals = c(1.5,seq(1,0,by=-0.05))
...
save(error_cat=error_cat,error_ind=error_ind,time_cat=time_cat,time_ind=time_ind,N_vals=N_vals,perc_vals=perc_vals,wind_vals=wind_vals,confus_cat_vals=confus_cat_vals,confus_ind_vals=confus_ind_vals,corr_vals=corr_vals,file='/homes/ebrush/priv/badgevsrecog/badgevsrecog_effect_of_categor_num.Rdata')
